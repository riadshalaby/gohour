...
| T-006 | Rewrite README and update AGENTS.md | ready_to_commit | README reflects web-UI-first workflow, two CLI commands, `~/.gohour/` layout, migration, removed commands; AGENTS.md updated; no broken references | n/a | implement |
