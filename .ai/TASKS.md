...
| T-006 | Rewrite README and update AGENTS.md | done | README reflects web-UI-first workflow, two CLI commands, `~/.gohour/` layout, migration, removed commands; AGENTS.md updated; no broken references | n/a | none |
